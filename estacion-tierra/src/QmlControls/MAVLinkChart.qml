...
ChartView {
    ...
    // The X axis labels are two lines tall (the format string starts with a <br/>), so they need
    // more room than the default or the bottom line gets clipped off the chart.
    margins.bottom:     ScreenTools.defaultFontPixelHeight * 3
