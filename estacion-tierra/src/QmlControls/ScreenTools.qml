...
Item {
    ...
    property real buttonBorderRadius:               defaultFontPixelWidth * 0.9

    // Centralized surface styling. Keeping these in one place is what stops the UI drifting back
    // into a patchwork of hardcoded radii.
    property real panelBorderRadius:                defaultFontPixelWidth * 1.5    ///< Large surfaces: drawers, tool pages, dialogs
    property real cardBorderRadius:                 defaultFontPixelWidth * 1.1    ///< Inner cards: group boxes, instrument panels
    property real panelOpacity:                     0.90                           ///< Translucency for floating surfaces over the map
    property real overlayOpacity:                   0.82                           ///< Translucency for overlays sitting directly on the map
