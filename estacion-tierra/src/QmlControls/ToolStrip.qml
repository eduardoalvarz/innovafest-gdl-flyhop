...
Rectangle {
    id:         _root
    // Tinted rather than made transparent with `opacity`, which would fade the buttons too.
    color:          Qt.rgba(qgcPal.toolbarBackground.r, qgcPal.toolbarBackground.g, qgcPal.toolbarBackground.b, ScreenTools.overlayOpacity)
